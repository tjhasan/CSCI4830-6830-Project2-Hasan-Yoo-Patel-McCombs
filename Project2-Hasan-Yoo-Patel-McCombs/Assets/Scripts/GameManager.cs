...
if(targetCount==0){
    if((level1Played == true && level2Played == false && level3Played == false && levelExtPlayed == false)||(level1Played == true && level2Played == true && level3Played == false && levelExtPlayed == false)||(level1Played == true && level2Played == true && level3Played == true && levelExtPlayed == false)){
        Debug.Log("here");
        elv.level = 1;
    }
